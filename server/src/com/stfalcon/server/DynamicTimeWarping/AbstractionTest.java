...
import com.stfalcon.server.DynamicTimeWarping.dtw.*;
import com.stfalcon.server.DynamicTimeWarping.timeseries.PAA;
...
public class AbstractionTest
{
      ...
      public static void main(String[] args)
      {
         ...
         else
         {
            ...
            final WarpPath coarsePath = DTW.getWarpPathBetween(shrunkI, shrunkJ, distFn);
            ...
            final TimeWarpInfo info = DTW.getWarpInfoBetween(tsI, tsJ, w, distFn);
