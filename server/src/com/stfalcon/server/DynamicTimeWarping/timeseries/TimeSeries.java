...
package com.stfalcon.server.DynamicTimeWarping.timeseries;

import com.stfalcon.server.DynamicTimeWarping.util.Arrays;
...
public class TimeSeries
{
   ...
   public TimeSeries(double[] btdatacontainer){
	   this();
	   boolean isFirstColTime = false;
	   final ArrayList currentLineValues = new ArrayList();
	   int length = btdatacontainer.length;
	   for(int i =0; i<length;i++){
		   currentLineValues.add(btdatacontainer[0]);
	   }
